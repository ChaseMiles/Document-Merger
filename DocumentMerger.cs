        ...
        static void Main(string[] args)
        {
            ...
            while (again == "yes")
            {
                ...
                try
                {
                    ...
                    {
                        Console.WriteLine("Error! Please re-enter the correct file name of the first document!");
                        fileName1 = Console.ReadLine();
                    }
                ...
                try
                {
                    ...
                    {
                        Console.WriteLine("Error! Please re-enter the correct file name of the second document!");
                        fileName2 = Console.ReadLine();
                    }
